...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style.css?v=20260801">
        ...
        <title>VanguardDoubleTrust - Contact Us</title>
    ...
    <style>
        ...
        * { border-color: rgba(255,255,255,0.10) !important; }
        ...
        .bg-dark-div, .navbar, .footer-area, .pay-support-area, .countries-area, .page-banner-area {
        ...
        .form-group .form-control:focus {
            border-color: #165DFF !important;
            box-shadow: 0 0 0 3px rgba(0, 77, 155, 0.1) !important;
        }
    ...
    .contact-info-item h3, .contact-form-wrap h3,
    .form-group label {
        color: #ffffff !important;
    }
    .contact-info-item p, .contact-form-wrap p {
    ...
    * { border-color: rgba(255,255,255,0.10) !important; }
    ...
    #google_translate_element .gt-fallback-btn {
        ...
        background-image: url("data:image/svg+xml;charset=UTF-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23004d9b' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'%3E%3Cpolyline points='6 9 12 15 18 9'/%3E%3C/svg%3E");
        ...
        box-shadow: 0 0 0 1px rgba(0,0,0,0.06), 0 2px 10px rgba(0,0,0,0.12);
        font-family: inherit;
        line-height: 1.2;
        white-space: nowrap;
        overflow: hidden;
    ...
    @media (max-width: 360px) {
      ...
      #google_translate_element .gt-fallback-btn { min-width: 104px; max-width: 116px; padding: 8px 30px 8px 10px; font-size: 11.5px; background-position: right 6px center; background-size: 12px 12px; }
    }
    ...
    <script type="text/javascript">
      /* ---- Google Translate Widget Init (must be declared BEFORE element.js loads) ---- */
      window.googleTranslateElementInit = function googleTranslateElementInit() {
        try {
          if (typeof google !== 'undefined' && google && google.translate && google.translate.TranslateElement) {
...
<body>
        ...
        <div class="container mw-1690">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="contact-us.php.html">Contact Us</a>
                    </li>
                </ul>
            </div>

            <div class="others-options style-two d-flex align-items-center">
                <div id="google_translate_element" class="d-flex align-items-center me-lg-4 me-md-3 me-2" aria-label="Language selector"><span class="gt-fallback-btn" aria-hidden="true">English ▾</span></div>
    ...
    <div class="mobile-navbar offcanvas offcanvas-end border-0" tabindex="-1" id="offcanvasExample">
        ...
        <div class="offcanvas-body">
            <ul class="mobile-menu">
                ...
                <li class="mobile-menu-list border-bottom"><a href="services.php.html">Services</a></li>
                <li class="mobile-menu-list active without-icon border-bottom"><a href="contact-us.php.html" class="nav-link">Contact Us</a></li>
    ...
    <div class="contact-area ptb-120">
        <div class="container mw-1690">
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    <div class="d-flex flex-column gap-4 h-100">
                        <div class="contact-info-item p-4 rounded-4 d-flex align-items-center gap-20">
                            <div class="icon rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 60px !important; height: 60px !important;">
                                <i class="ti ti-headset fs-30"></i>
                            </div>
                            <div>
                                <h3 class="fs-20 mb-2">24/7 Customer Support</h3>
                                <p class="mb-0"><a href="tel:+17472802980" class="text-decoration-none">+1 747 280 2980</a></p>
                                <p class="mb-0" style="font-size: 0.85rem;">Available around the clock</p>
                            </div>
                        </div>

                        <div class="contact-info-item p-4 rounded-4 d-flex align-items-center gap-20">
                            <div class="icon rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 60px !important; height: 60px !important;">
                                <i class="ti ti-mail fs-30"></i>
                            </div>
                            <div>
                                <h3 class="fs-20 mb-2">Email Us</h3>
                                <p class="mb-0"><a href="mailto:contact@VanguardDoubleTrust.com" class="text-decoration-none">contact@VanguardDoubleTrust.com</a></p>
                                <p class="mb-0" style="font-size: 0.85rem;">We reply within 24 hours</p>
                            </div>
                        </div>

                        <div class="contact-info-item p-4 rounded-4 d-flex align-items-center gap-20">
                            <div class="icon rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 60px !important; height: 60px !important;">
                                <i class="ti ti-map-pin fs-30"></i>
                            </div>
                            <div>
                                <h3 class="fs-20 mb-2">Our Office</h3>
                                <p class="mb-0"></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="contact-form-wrap h-100">
                        ...
                        <p class="mb-4">Have a question about your account, need help with a transaction, or want to learn more about our services? Fill out the form below and our team will get back to you shortly.</p>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="contactPhone" name="phone" placeholder="+44 (0) 123 456 7890">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="contactSubject">Subject</label>
                                        <select class="form-control form-select" id="contactSubject" name="subject">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="contactMessage" name="message" rows="5" placeholder="How can we help you today?" required></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div id="contactAlert" class="mb-3" style="display: none;"></div>
                                    <button type="submit" id="contactSubmitBtn" class="default-btn border-0 w-100" style="border-radius: 10px !important;">Send Message</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="map-iframe" style="height: 400px;">
                       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11848.424687191819!2d-88.04646229418375!3d42.06234357925572!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880fa57e2edfbf3d%3A0x7ac2c18c1c615dd7!2s1299%20Zurich%20Way%2C%20Schaumburg%2C%20IL%2060196!5e0!3m2!1sen!2sus!4v1773851856908!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function showAlert(type, message) {
                ...
                alertBox.className = "alert " + bgClass + " text-center p-3 rounded";
                alertBox.style.color = type === "success" ? "#0f5132" : "#842029";
                alertBox.style.backgroundColor = type === "success" ? "#d1e7dd" : "#f8d7da";
                alertBox.style.border = type === "success" ? "1px solid #badbcc" : "1px solid #f5c2c7";
            ...
            form.addEventListener("submit", async function (e) {
                ...
                try {
                    ...
                    showAlert("success", data.message || "Thank you! Your message has been received. Our team will contact you shortly.");
                    form.reset();
                } catch (err) {
                    showAlert("error", err.message || "Failed to submit message. Please try again.");
                } finally {
                    if (submitBtn) {
