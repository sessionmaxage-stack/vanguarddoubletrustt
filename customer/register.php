                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="brname" id="brname" class="form-select" required="">
                                                ...
                                                <option value='RBSUS001'>New York Main Branch</option>
                                                <option value='RBSUS002'>Los Angeles Branch</option>
                                                <option value='RBSUS003'>Chicago Branch</option>
                                                <option value='RBSUS004'>Houston Branch</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
