(function (root, factory) {
  ...
  const DICT = {
    ...
    es: {
      ...
      xfer_dialogTitle: "Autorización de Transferencia",
      xfer_confirmTitle: "Confirmar Transferencia",
      xfer_proceedToConfirm: "Proceder a la Confirmación",
      xfer_backToPin: "← Volver al PIN",
      xfer_confirmButton: "Confirmar Transferencia",
      xfer_cancelButton: "Cancelar",
      xfer_pinLabel: "PIN de Transferencia",
      xfer_pinPlaceholder: "Introduce tu PIN de Transferencia de 6 dígitos",
      xfer_pinRequired: "El PIN de Transferencia es obligatorio",
      xfer_pinRequired6d: "El PIN de Transferencia debe tener exactamente 6 dígitos numéricos",
      xfer_pinInvalid: "PIN de Transferencia no válido",
      xfer_pinVerified: "PIN de Transferencia verificado correctamente",
      xfer_sealedNotice: "Los parámetros de la transferencia han sido sellados criptográficamente",
      xfer_processing: "Verificando el PIN de Transferencia y procesando la transferencia...",
      xfer_success: "Transferencia completada correctamente",
      xfer_failed: "La transferencia falló",
      xfer_amountLabel: "Monto",
      xfer_recipientLabel: "Beneficiario",
      xfer_referenceLabel: "Referencia",
      xfer_newBalanceLabel: "Nuevo Saldo",
      xfer_errorOtpBlocked: "La autenticación OTP está permanentemente deshabilitada. Utiliza exclusivamente tu PIN de Transferencia.",
      xfer_reviewHeading: "Revisar y Confirmar",
      xfer_feeLabel: "Comisión",
      xfer_totalLabel: "Débito Total",
      xfer_sendingLabel: "Enviando a tu transferencia protegida por PIN de Transferencia"
    },
    fr: {
      _name: "Français",
      ...
      xfer_dialogTitle: "Autorisation de Virement",
      xfer_confirmTitle: "Confirmer le Virement",
      xfer_proceedToConfirm: "Passer à la Confirmation",
      xfer_backToPin: "← Retour au Code PIN",
      xfer_confirmButton: "Confirmer le Virement",
      xfer_cancelButton: "Annuler",
      xfer_pinLabel: "Code PIN de Virement",
      xfer_pinPlaceholder: "Entrez votre Code PIN de Virement à 6 chiffres",
      xfer_pinRequired: "Le Code PIN de Virement est requis",
      xfer_pinRequired6d: "Le Code PIN de Virement doit comporter exactement 6 chiffres numériques",
      xfer_pinInvalid: "Code PIN de Virement non valide",
      xfer_pinVerified: "Code PIN de Virement vérifié avec succès",
      xfer_sealedNotice: "Les paramètres du virement ont été scellés cryptographiquement",
      xfer_processing: "Vérification du Code PIN de Virement et traitement du virement...",
      xfer_success: "Virement effectué avec succès",
      xfer_failed: "Échec du virement",
      xfer_amountLabel: "Montant",
      xfer_recipientLabel: "Bénéficiaire",
      xfer_referenceLabel: "Référence",
      xfer_newBalanceLabel: "Nouveau Solde",
    ...
    de: {
      ...
      xfer_dialogTitle: "Überweisungsautorisierung",
      xfer_confirmTitle: "Überweisung bestätigen",
      xfer_proceedToConfirm: "Zur Bestätigung fortfahren",
      xfer_backToPin: "← Zurück zur PIN",
      xfer_confirmButton: "Überweisung bestätigen",
      xfer_cancelButton: "Abbrechen",
      xfer_pinLabel: "Überweisungs-PIN",
      xfer_pinPlaceholder: "Geben Sie Ihre 6-stellige Überweisungs-PIN ein",
      xfer_pinRequired: "Überweisungs-PIN ist erforderlich",
      xfer_pinRequired6d: "Überweisungs-PIN muss genau 6 Ziffern lang sein",
      xfer_pinInvalid: "Ungültige Überweisungs-PIN",
      xfer_pinVerified: "Überweisungs-PIN erfolgreich verifiziert",
      xfer_sealedNotice: "Überweisungsparameter wurden kryptografisch versiegelt",
      xfer_processing: "Überweisungs-PIN wird verifiziert und Überweisung wird verarbeitet...",
      xfer_success: "Überweisung erfolgreich abgeschlossen",
      xfer_failed: "Überweisung fehlgeschlagen",
      xfer_amountLabel: "Betrag",
      xfer_recipientLabel: "Empfänger",
      xfer_referenceLabel: "Verwendungszweck",
      xfer_newBalanceLabel: "Neuer Kontostand",
      xfer_errorOtpBlocked: "OTP-Authentifizierung ist dauerhaft deaktiviert. Verwenden Sie ausschließlich Ihre Überweisungs-PIN.",
    ...
    pt: {
      ...
      xfer_dialogTitle: "Autorização de Transferência",
      xfer_confirmTitle: "Confirmar Transferência",
      xfer_proceedToConfirm: "Prosseguir para Confirmação",
      xfer_backToPin: "← Voltar ao PIN",
      xfer_confirmButton: "Confirmar Transferência",
      xfer_cancelButton: "Cancelar",
      xfer_pinLabel: "PIN de Transferência",
      xfer_pinPlaceholder: "Digite seu PIN de Transferência de 6 dígitos",
      xfer_pinRequired: "O PIN de Transferência é obrigatório",
      xfer_pinRequired6d: "O PIN de Transferência deve ter exatamente 6 dígitos numéricos",
      xfer_pinInvalid: "PIN de Transferência inválido",
      xfer_pinVerified: "PIN de Transferência verificado com sucesso",
      xfer_sealedNotice: "Os parâmetros da transferência foram selados criptograficamente",
      xfer_processing: "Verificando o PIN de Transferência e processando a transferência...",
      xfer_success: "Transferência concluída com sucesso",
      xfer_failed: "Falha na transferência",
      xfer_amountLabel: "Valor",
      xfer_recipientLabel: "Beneficiário",
      xfer_referenceLabel: "Referência",
      xfer_newBalanceLabel: "Novo Saldo",
      xfer_errorOtpBlocked: "A autenticação OTP está permanentemente desativada. Use exclusivamente seu PIN de Transferência.",
      xfer_reviewHeading: "Revisar e Confirmar",
      xfer_feeLabel: "Taxa",
      xfer_totalLabel: "Débito Total",
      xfer_sendingLabel: "Enviando para sua transferência protegida por PIN de Transferência"
    },
    ru: {
      _name: "Русский",
      ...
      xfer_dialogTitle: "Авторизация перевода",
      xfer_confirmTitle: "Подтвердить перевод",
      xfer_proceedToConfirm: "Перейти к подтверждению",
      xfer_backToPin: "← Назад к PIN-коду",
      xfer_confirmButton: "Подтвердить перевод",
      xfer_cancelButton: "Отмена",
      xfer_pinLabel: "PIN-код перевода",
      xfer_pinPlaceholder: "Введите 6-значный PIN-код перевода",
      xfer_pinRequired: "PIN-код перевода обязателен",
      xfer_pinRequired6d: "PIN-код перевода должен содержать ровно 6 цифр",
      xfer_pinInvalid: "Неверный PIN-код перевода",
      xfer_pinVerified: "PIN-код перевода успешно проверен",
      xfer_sealedNotice: "Параметры перевода криптографически запечатаны",
      xfer_processing: "Проверка PIN-кода перевода и обработка перевода...",
      xfer_success: "Перевод успешно выполнен",
      xfer_failed: "Перевод не выполнен",
      xfer_amountLabel: "Сумма",
      xfer_recipientLabel: "Получатель",
      xfer_referenceLabel: "Назначение платежа",
      xfer_newBalanceLabel: "Новый остаток",
      xfer_errorOtpBlocked: "OTP-аутентификация постоянно отключена. Используйте исключительно PIN-код перевода.",
    ...
    zh: {
      ...
      xfer_dialogTitle: "转账授权",
      xfer_confirmTitle: "确认转账",
      xfer_proceedToConfirm: "进入确认流程",
      xfer_backToPin: "← 返回 PIN",
      xfer_confirmButton: "确认转账",
      xfer_cancelButton: "取消",
      xfer_pinLabel: "转账 PIN",
      xfer_pinPlaceholder: "请输入 6 位转账 PIN",
      xfer_pinRequired: "转账 PIN 为必填项",
      xfer_pinRequired6d: "转账 PIN 必须为 6 位数字",
      xfer_pinInvalid: "转账 PIN 无效",
      xfer_pinVerified: "转账 PIN 验证成功",
      xfer_sealedNotice: "转账参数已加密封存",
      xfer_processing: "正在验证转账 PIN 并处理转账...",
      xfer_success: "转账成功完成",
      xfer_failed: "转账失败",
      xfer_amountLabel: "金额",
      xfer_recipientLabel: "收款人",
      xfer_referenceLabel: "备注",
      xfer_newBalanceLabel: "新余额",
      xfer_errorOtpBlocked: "OTP 认证已永久停用。请仅使用您的转账 PIN。",
    ...
    ar: {
      ...
      xfer_dialogTitle: "تفويض التحويل",
      xfer_confirmTitle: "تأكيد التحويل",
      xfer_proceedToConfirm: "الانتقال إلى التأكيد",
      xfer_backToPin: "← العودة إلى الرقم السري",
      xfer_confirmButton: "تأكيد التحويل",
      xfer_cancelButton: "إلغاء",
      xfer_pinLabel: "الرقم السري للتحويل",
      xfer_pinPlaceholder: "أدخل الرقم السري للتحويل المكون من 6 أرقام",
      xfer_pinRequired: "الرقم السري للتحويل مطلوب",
      xfer_pinRequired6d: "يجب أن يتكون الرقم السري للتحويل من 6 أرقام رقمية بالضبط",
      xfer_pinInvalid: "الرقم السري للتحويل غير صالح",
      xfer_pinVerified: "تم التحقق من الرقم السري للتحويل بنجاح",
      xfer_sealedNotice: "تم ختم معلمات التحويل تشفيريًا",
      xfer_processing: "جارٍ التحقق من الرقم السري للتحويل ومعالجة التحويل...",
      xfer_success: "تم التحويل بنجاح",
      xfer_failed: "فشل التحويل",
      xfer_amountLabel: "المبلغ",
      xfer_recipientLabel: "المستلم",
      xfer_referenceLabel: "المرجع",
      xfer_newBalanceLabel: "الرصيد الجديد",
      xfer_errorOtpBlocked: "المصادقة OTP معطلة بشكل دائم. استخدم الرقم السري للتحويل حصريًا.",
    ...
    it: {
      ...
      xfer_dialogTitle: "Autorizzazione Bonifico",
      xfer_confirmTitle: "Conferma Bonifico",
      xfer_proceedToConfirm: "Procedi alla Conferma",
      xfer_backToPin: "← Torna al PIN",
      xfer_confirmButton: "Conferma Bonifico",
      xfer_cancelButton: "Annulla",
      xfer_pinLabel: "PIN di Bonifico",
      xfer_pinPlaceholder: "Inserisci il tuo PIN di Bonifico a 6 cifre",
      xfer_pinRequired: "Il PIN di Bonifico è obbligatorio",
      xfer_pinRequired6d: "Il PIN di Bonifico deve essere esattamente di 6 cifre numeriche",
      xfer_pinInvalid: "PIN di Bonifico non valido",
      xfer_pinVerified: "PIN di Bonifico verificato con successo",
      xfer_sealedNotice: "I parametri del bonifico sono stati sigillati crittograficamente",
      xfer_processing: "Verifica del PIN di Bonifico e elaborazione del bonifico in corso...",
      xfer_success: "Bonifico completato con successo",
      xfer_failed: "Bonifico fallito",
      xfer_amountLabel: "Importo",
      xfer_recipientLabel: "Beneficiario",
      xfer_referenceLabel: "Riferimento",
      xfer_newBalanceLabel: "Nuovo Saldo",
      xfer_errorOtpBlocked: "L'autenticazione OTP è permanentemente disabilitata. Utilizza esclusivamente il tuo PIN di Bonifico.",
      xfer_reviewHeading: "Revisione e Conferma",
      xfer_feeLabel: "Commissione",
      xfer_totalLabel: "Addebito Totale",
      xfer_sendingLabel: "Invio in corso al tuo bonifico protetto da PIN di Bonifico"
    },
    nl: {
      _name: "Nederlands",
      nav_dashboard: "Dashboard",
      ...
      xfer_dialogTitle: "Autorisatie Bankoverschrijving",
      xfer_confirmTitle: "Bevestig Bankoverschrijving",
      xfer_proceedToConfirm: "Ga naar Bevestiging",
      xfer_backToPin: "← Terug naar PIN",
      xfer_confirmButton: "Bevestig Bankoverschrijving",
      xfer_cancelButton: "Annuleren",
      xfer_pinLabel: "Bankoverschrijving-PIN",
      xfer_pinPlaceholder: "Voer je 6-cijferige Bankoverschrijving-PIN in",
      xfer_pinRequired: "Bankoverschrijving-PIN is verplicht",
      xfer_pinRequired6d: "Bankoverschrijving-PIN moet precies 6 numerieke cijfers zijn",
      xfer_pinInvalid: "Ongeldige Bankoverschrijving-PIN",
      xfer_pinVerified: "Bankoverschrijving-PIN succesvol geverifieerd",
      xfer_sealedNotice: "Parameters van de bankoverschrijving zijn cryptografisch verzegeld",
      xfer_processing: "Bankoverschrijving-PIN wordt geverifieerd en bankoverschrijving wordt verwerkt...",
      xfer_success: "Bankoverschrijving succesvol voltooid",
      xfer_failed: "Bankoverschrijving mislukt",
      xfer_amountLabel: "Bedrag",
      xfer_recipientLabel: "Begunstigde",
      xfer_referenceLabel: "Referentie",
      xfer_newBalanceLabel: "Nieuw Saldo",
      xfer_errorOtpBlocked: "OTP-authenticatie is permanent uitgeschakeld. Gebruik uitsluitend je Bankoverschrijving-PIN.",
    ...
    ja: {
      ...
      common_required: "必須",
      xfer_dialogTitle: "銀行振込の承認",
      xfer_confirmTitle: "銀行振込の確認",
      xfer_proceedToConfirm: "確認手続きへ進む",
      xfer_backToPin: "← 暗証番号に戻る",
      xfer_confirmButton: "銀行振込を確認",
      xfer_cancelButton: "キャンセル",
      xfer_pinLabel: "振込暗証番号",
      xfer_pinPlaceholder: "6桁の振込暗証番号を入力してください",
      xfer_pinRequired: "振込暗証番号は必須です",
      xfer_pinRequired6d: "振込暗証番号は6桁の数字で入力してください",
      xfer_pinInvalid: "振込暗証番号が無効です",
      xfer_pinVerified: "振込暗証番号の認証に成功しました",
      xfer_sealedNotice: "振込パラメータは暗号学的に封印されています",
      xfer_processing: "振込暗証番号を確認し、振込を処理しています...",
      xfer_success: "振込が正常に完了しました",
      xfer_failed: "振込に失敗しました",
      xfer_amountLabel: "金額",
      xfer_recipientLabel: "受取人",
      xfer_referenceLabel: "参照",
      xfer_newBalanceLabel: "新しい残高",
      xfer_errorOtpBlocked: "OTP認証は永久に無効化されています。振込暗証番号のみを使用してください。",
    ...
    ko: {
      ...
      common_required: "필수",
      xfer_dialogTitle: "이체 승인",
      xfer_confirmTitle: "이체 확인",
      xfer_proceedToConfirm: "확인 절차로 진행",
      xfer_backToPin: "← PIN으로 돌아가기",
      xfer_confirmButton: "이체 확인",
      xfer_cancelButton: "취소",
      xfer_pinLabel: "이체 PIN",
      xfer_pinPlaceholder: "6자리 이체 PIN을 입력하세요",
      xfer_pinRequired: "이체 PIN은 필수입니다",
      xfer_pinRequired6d: "이체 PIN은 정확히 6자리 숫자여야 합니다",
      xfer_pinInvalid: "잘못된 이체 PIN입니다",
      xfer_pinVerified: "이체 PIN이 성공적으로 인증되었습니다",
      xfer_sealedNotice: "이체 매개변수가 암호학적으로 봉인되었습니다",
      xfer_processing: "이체 PIN을 확인하고 이체를 처리하는 중...",
      xfer_success: "이체가 성공적으로 완료되었습니다",
      xfer_failed: "이체에 실패했습니다",
      xfer_amountLabel: "금액",
      xfer_recipientLabel: "수취인",
      xfer_referenceLabel: "참조",
      xfer_newBalanceLabel: "새 잔액",
      xfer_errorOtpBlocked: "OTP 인증이 영구적으로 비활성화되었습니다. 이체 PIN만 사용하세요.",
      xfer_reviewHeading: "검토 및 확인",
      xfer_feeLabel: "수수료",
      xfer_totalLabel: "총 출금액",
      xfer_sendingLabel: "이체 PIN으로 보호된 이체 전송 중"
    },
    hi: {
      _name: "हिन्दी",
      ...
      xfer_dialogTitle: "ट्रांसफर प्राधिकरण",
      xfer_confirmTitle: "ट्रांसफर की पुष्टि करें",
      xfer_proceedToConfirm: "पुष्टि के लिए आगे बढ़ें",
      xfer_backToPin: "← पिन पर वापस जाएं",
      xfer_confirmButton: "ट्रांसफर की पुष्टि करें",
      xfer_cancelButton: "रद्द करें",
      xfer_pinLabel: "ट्रांसफर पिन",
      xfer_pinPlaceholder: "अपना 6 अंकों का ट्रांसफर पिन दर्ज करें",
      xfer_pinRequired: "ट्रांसफर पिन अनिवार्य है",
      xfer_pinRequired6d: "ट्रांसफर पिन ठीक 6 अंकों का होना चाहिए",
      xfer_pinInvalid: "अमान्य ट्रांसफर पिन",
      xfer_pinVerified: "ट्रांसफर पिन सफलतापूर्वक सत्यापित हुआ",
      xfer_sealedNotice: "ट्रांसफर पैरामीटर क्रिप्टोग्राफिक रूप से सील कर दिए गए हैं",
      xfer_processing: "ट्रांसफर पिन सत्यापित किया जा रहा है और ट्रांसफर संसाधित किया जा रहा है...",
      xfer_success: "ट्रांसफर सफलतापूर्वक पूरा हुआ",
      xfer_failed: "ट्रांसफर विफल रहा",
      xfer_amountLabel: "राशि",
      xfer_recipientLabel: "प्राप्तकर्ता",
      xfer_referenceLabel: "संदर्भ",
      xfer_newBalanceLabel: "नया बैलेंस",
      xfer_errorOtpBlocked: "OTP प्रमाणीकरण स्थायी रूप से अक्षम है। केवल अपना ट्रांसफर पिन उपयोग करें।",
      xfer_reviewHeading: "समीक्षा और पुष्टि",
      xfer_feeLabel: "शुल्क",
      xfer_totalLabel: "कुल डेबिट",
      xfer_sendingLabel: "आपके ट्रांसफर पिन-सुरक्षित ट्रांसफर पर भेजा जा रहा है"
    },
    bn: {
      _name: "বাংলা",
    ...
    tr: {
      ...
      xfer_dialogTitle: "Transfer Yetkilendirmesi",
      xfer_confirmTitle: "Transferi Onayla",
      xfer_proceedToConfirm: "Onayımlamaya Geç",
      xfer_backToPin: "← PIN'e Geri Dön",
      xfer_confirmButton: "Transferi Onayla",
      xfer_cancelButton: "İptal",
      xfer_pinLabel: "Transfer PIN'i",
      xfer_pinPlaceholder: "6 haneli Transfer PIN'inizi girin",
      xfer_pinRequired: "Transfer PIN'i zorunludur",
      xfer_pinRequired6d: "Transfer PIN'i tam olarak 6 rakamlı olmalıdır",
      xfer_pinInvalid: "Geçersiz Transfer PIN'i",
      xfer_pinVerified: "Transfer PIN'i başarıyla doğrulandı",
      xfer_sealedNotice: "Transfer parametreleri şifreli olarak mühürlendi",
      xfer_processing: "Transfer PIN'i doğrulanıyor ve transfer işleniyor...",
      xfer_success: "Transfer başarıyla tamamlandı",
      xfer_failed: "Transfer başarısız oldu",
      xfer_amountLabel: "Tutar",
      xfer_recipientLabel: "Alıcı",
      xfer_referenceLabel: "Referans",
      xfer_newBalanceLabel: "Yeni Bakiye",
      xfer_errorOtpBlocked: "OTP kimlik doğrulaması kalıcı olarak devre dışı bırakıldı. Yalnızca Transfer PIN'inizi kullanın.",
      xfer_reviewHeading: "Gözden Geçir ve Onayla",
      xfer_feeLabel: "Ücret",
      xfer_totalLabel: "Toplam Borç",
      xfer_sendingLabel: "Transfer PIN'inizle korunan transferinize gönderiliyor"
    },
    vi: {
      _name: "Tiếng Việt",
      ...
      xfer_dialogTitle: "Ủy quyền Chuyển khoản",
      xfer_confirmTitle: "Xác nhận Chuyển khoản",
      xfer_proceedToConfirm: "Tiến hành Xác nhận",
      xfer_backToPin: "← Quay lại PIN",
      xfer_confirmButton: "Xác nhận Chuyển khoản",
      xfer_cancelButton: "Hủy",
      xfer_pinLabel: "PIN Chuyển khoản",
      xfer_pinPlaceholder: "Nhập PIN Chuyển khoản 6 chữ số của bạn",
      xfer_pinRequired: "PIN Chuyển khoản là bắt buộc",
      xfer_pinRequired6d: "PIN Chuyển khoản phải có đúng 6 chữ số",
      xfer_pinInvalid: "PIN Chuyển khoản không hợp lệ",
      xfer_pinVerified: "PIN Chuyển khoản đã được xác minh thành công",
      xfer_sealedNotice: "Các tham số chuyển khoản đã được mã hóa niêm phong",
      xfer_processing: "Đang xác minh PIN Chuyển khoản và xử lý chuyển khoản...",
      xfer_success: "Chuyển khoản đã hoàn tất thành công",
      xfer_failed: "Chuyển khoản thất bại",
      xfer_amountLabel: "Số tiền",
      xfer_recipientLabel: "Người nhận",
      xfer_referenceLabel: "Tham chiếu",
      xfer_newBalanceLabel: "Số dư Mới",
      xfer_errorOtpBlocked: "Xác thực OTP đã bị vô hiệu hóa vĩnh viễn. Chỉ sử dụng PIN Chuyển khoản của bạn.",
  ...
  function t(code, key, vars) {
    ...
    if (vars && typeof vars === "object") {
      for (const k of Object.keys(vars)) {
        ...
        str = String(str).replace(re, String(safeVal));
      }
    }
    return str;
  }
    ...
    scope.querySelectorAll && scope.querySelectorAll("[data-i18n]").forEach((el) => {
      ...
      if (varsObj) {
        for (const k of Object.keys(varsObj)) {
          ...
          str = str.replace(new RegExp(`\\{\\{${safeKey}\\}\\}`, "g"), String(safeVal));
        }
      }
      el.textContent = str;
    });
