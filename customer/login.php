...
<body>
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-left">
                ...
                <div class="welcome-text">
                    <h1 data-i18n="login_left_welcomeback">Welcome Back</h1>
                    <p data-i18n="login_left_tagline">Securely manage your finances with ease.</p>
                </div>

                <div class="security-features">
                    <div class="security-item">
                        <div class="security-icon"><i class="fas fa-shield-alt" aria-hidden="true"></i></div>
                        <div class="security-text">
                            <h4 data-i18n="login_left_sec1_h">Bank-Level Security</h4>
                            <p data-i18n="login_left_sec1_p">256-bit encryption active</p>
                        </div>
                    </div>
                    <div class="security-item">
                        <div class="security-icon"><i class="fas fa-lock" aria-hidden="true"></i></div>
                        <div class="security-text">
                            <h4 data-i18n="login_left_sec2_h">Secure Login</h4>
                            <p data-i18n="login_left_sec2_p">Protected authentication</p>
                        </div>
                    </div>
                    <div class="security-item">
                        <div class="security-icon"><i class="fas fa-clock" aria-hidden="true"></i></div>
                        <div class="security-text">
                            <h4 data-i18n="login_left_sec3_h">24/7 Access</h4>
                            <p data-i18n="login_left_sec3_p">Banking anytime, anywhere</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="login-right">
                <div id="loginRightHeader" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:16px; margin-bottom:36px;">
                    <div id="loginMobileBrand" class="d-lg-none" style="display:flex;align-items:center;gap:10px;">
                ...
                <div class="form-header">
                    <h2 data-i18n="login_signin_heading">Sign In</h2>
                    <p data-i18n="login_signin_sub">Enter your details to access your account.</p>
                </div>


                <div class="step-indicator" aria-label="login steps">
                ...
                <div class="alert-section">
                    ...
                    <div class="alert-text" data-i18n="login_alert_emailbegin">
                ...
                <form id="multiStepForm" method="POST">
                    <div id="step1">
                        <div class="mb-3">
                            <label for="email-1" class="form-label" data-i18n="login_label_email">Email Address</label>
                            <input type="text" class="form-control" id="email-1" name="login" placeholder="name@example.com" data-i18n-placeholder="login_placeholder_email" required="">
                            <div class="invalid-feedback" data-i18n="login_invalid_email">Please enter a valid email address.</div>
                        </div>
                        <div class="form-check mb-4">
                            <input type="checkbox" class="form-check-input" id="rememberMe">
                            <label class="form-check-label text-secondary small" for="rememberMe" data-i18n="login_label_rememberdevice">Remember my device</label>
                        </div>
                        <button type="button" class="btn-login" onclick="validateEmail()" data-i18n-label="login_btn_continue"><span data-i18n="login_btn_continue">Continue</span> <i class="fas fa-arrow-right ms-2"></i></button>
                    </div>

                    <div id="step2" style="display: none;">
                        <div class="mb-3">
                            <label for="password-1" class="form-label" data-i18n="login_label_password">Password</label>
                            <div class="password-field">
                                <input type="password" class="form-control" name="password" id="password-1" placeholder="Enter your password" data-i18n-placeholder="login_placeholder_password" required="">
                                <button type="button" class="password-toggle" id="password-toggle" aria-label="Toggle password visibility">
                                    <i class="far fa-eye"></i>
                                </button>
                            </div>
                        </div>
                        <button name="go" id="go" class="btn-login" type="submit" data-i18n="login_btn_access">Access Account</button>
                        <button type="button" class="btn btn-link text-secondary w-100 mt-2 text-decoration-none small" onclick="goBack()"><span data-i18n="login_btn_backemail">Back to Email</span></button>
                    </div>
                </form>

                <div class="mt-4 text-center">
                    <p class="small text-secondary mb-2">
                        <a href="#" class="login-link contactLink" data-i18n="login_link_forgotpw">Forgot Password?</a>
                    </p>
                    <p class="small text-secondary">
                        <span data-i18n="login_newhere">New here?</span> <a href="register.php" class="login-link" data-i18n="login_link_createacc">Create an Account</a>
                    </p>
                </div>
        ...
        <div class="text-center mt-4">
            <a href="../index.php" class="text-decoration-none text-secondary small fw-bold"><i class="fas fa-arrow-left me-1"></i> <span data-i18n="login_back_home">Back to Home</span></a>
            <div class="mt-2 small text-muted" data-i18n="login_copyright">&copy; 2026 VanguardDoubleTrust. All rights reserved.</div>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            try {
                var langMount = document.getElementById("langDropdownContainer");
                if (langMount && window.VT && VT.UI && typeof VT.UI.initLangDropdown === "function") {
                    VT.UI.initLangDropdown(langMount, {
